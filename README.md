...
![Go-MySQL-Driver logo](https://raw.github.com/wiki/go-db-driver/mysql/gomysql_m.png "Golang Gopher holding the MySQL Dolphin")
...
## Features
  * Lightweight and [fast](https://github.com/go-db-driver/sql-benchmark "golang MySQL-Driver performance")
  * Native Go implementation. No C-bindings, just pure Go
  * Connections over TCP/IPv4, TCP/IPv6, Unix domain sockets or [custom protocols](https://godoc.org/github.com/go-db-driver/mysql#DialFunc)
...
```bash
go get -u github.com/go-db-driver/mysql
```
...
[Examples are available in our Wiki](https://github.com/go-db-driver/mysql/wiki/Examples "Go-MySQL-Driver Examples").
...
Alternatively, [Config.FormatDSN](https://godoc.org/github.com/go-db-driver/mysql#Config.FormatDSN) can be used to create a DSN string by filling a struct.
...
Default:        false
```
`allowOldPasswords=true` allows the usage of the insecure old password method. This should be avoided, but is necessary in some cases. See also [the old_passwords wiki page](https://github.com/go-db-driver/mysql/wiki/old_passwords).
...
Server public keys can be registered with [`mysql.RegisterServerPubKey`](https://godoc.org/github.com/go-db-driver/mysql#RegisterServerPubKey), which can then be used by the assigned name in the DSN.
...
```go
import "github.com/go-db-driver/mysql"
```
...
See the [godoc of Go-MySQL-Driver](https://godoc.org/github.com/go-db-driver/mysql "golang mysql driver documentation") for details.
...
**Caution:** As of Go 1.1, this makes `time.Time` the only variable type you can scan `DATE` and `DATETIME` values into. This breaks for example [`sql.RawBytes` support](https://github.com/go-db-driver/mysql/wiki/Examples#rawbytes).
...
## Testing / Development
To run the driver tests you may need to adjust the configuration. See the [Testing Wiki-Page](https://github.com/go-db-driver/mysql/wiki/Testing "Testing") for details.

Go-MySQL-Driver is not feature-complete yet. Your help is very appreciated.
If you want to contribute, you can work on an [open issue](https://github.com/go-db-driver/mysql/issues?state=open) or review a [pull request](https://github.com/go-db-driver/mysql/pulls).

See the [Contribution Guidelines](https://github.com/go-db-driver/mysql/blob/master/.github/CONTRIBUTING.md) for details.

---------------------------------------

## License
Go-MySQL-Driver is licensed under the [Mozilla Public License Version 2.0](https://raw.github.com/go-db-driver/mysql/master/LICENSE)
...
You can read the full terms here: [LICENSE](https://raw.github.com/go-db-driver/mysql/master/LICENSE).

![Go Gopher and MySQL Dolphin](https://raw.github.com/wiki/go-db-driver/mysql/go-mysql-driver_m.jpg "Golang Gopher transporting the MySQL Dolphin in a wheelbarrow")
