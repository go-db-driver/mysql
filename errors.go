...
var (
	...
	ErrOldPassword       = errors.New("this user requires old password authentication. If you still want to use it, please add 'allowOldPasswords=1' to your DSN. See also https://github.com/go-db-driver/mysql/wiki/old_passwords")
	...
	// to trigger a resend.
	// See https://github.com/go-db-driver/mysql/pull/302
